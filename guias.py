...
"""
    },
    {
        ...
        "destaque": False,
        "conteudo": """
<p>Essa foi uma das nossas frustrações: compramos canguru achando que era só vestir e pronto, mas testamos mais de um que deixava a nossa filha numa posição claramente ruim: pernas penduradas, corpo curvado, peso mal distribuído.</p>

<p>Demorou pra gente entender que existe uma diferença técnica real entre os modelos. A maioria dos cangurus baratos de loja tem o mesmo problema.</p>

<h2>O problema dos modelos mais simples</h2>

<p>Muito canguru barato sustenta o bebê só pela virilha, deixando as pernas caídas para baixo, como se ele estivesse pendurado. Todo o peso fica concentrado em um ponto pequeno.</p>

<p>A recomendação de fisioterapeutas e pediatras vai no sentido oposto: o ideal é que a coxa fique apoiada até a dobra do joelho, com os joelhos mais altos que o bumbum, o que costumam chamar de <strong>posição em M</strong> ou "posição de sapinho". Nessa posição, o peso se distribui pelo quadril inteiro, em vez de ficar todo na virilha.</p>
...
<ul>
<li><strong>Joelhos mais altos que o bumbum</strong>, formando um M. Se as pernas estão retas pra baixo, o modelo não está apoiando direito.</li>
<li><strong>Coxa apoiada até o joelho</strong>, não só a virilha.</li>
<li><strong>Costas levemente arredondadas</strong>, respeitando a curva natural, não esticadas à força nem dobradas demais.</li>
<li><strong>Queixo longe do peito.</strong> Deve caber pelo menos um dedo entre o queixo e o peitoral do bebê. Queixo colado dificulta a respiração, e esse é o ponto mais importante da lista.</li>
<li><strong>Rosto visível.</strong> Você deve conseguir ver o rosto sem afastar tecido.</li>
<li><strong>Perto o suficiente pra beijar</strong> a cabeça do bebê sem se esticar. Se está mais baixo que isso, está frouxo demais.</li>
<li><strong>Ajustado, não folgado.</strong> Bebê solto dentro do canguru escorrega e curva o corpo.</li>
</ul>

<h2>Antes de comprar</h2>

<p>Confira a <strong>faixa de peso</strong> indicada pelo fabricante e se o modelo tem apoio de cabeça. Nos primeiros meses, quando o bebê ainda não sustenta o pescoço, isso não é opcional.</p>

<p>Verifique também se dá pra ajustar em quem vai usar. Cangurus de tamanho único costumam ficar bem em uma pessoa da casa e mal na outra.</p>

<p>Se puder, experimente antes ou compre de um lugar com política de troca clara. É um item que só dá pra avaliar de verdade com o bebê dentro.</p>

<h2>Um aviso</h2>

<p>Este guia é a nossa experiência somada ao que se recomenda de forma geral sobre posicionamento. Não substitui orientação de pediatra ou fisioterapeuta. Se você notar qualquer desconforto, choro ao ser colocado, ou tiver dúvida sobre o quadril do seu bebê, converse com quem acompanha ele.</p>
"""
    },
    {
